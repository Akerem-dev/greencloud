...
const CONTROL_OR_BIDI_PATTERN =
  /[\u0000-\u001F\u007F-\u009F\u202A-\u202E\u2066-\u2069]/u;
const SAFE_HOST_PATTERN = /^(?:localhost|[a-z0-9.-]+)$/iu;
...
function normalizeHost(value) {
  ...
  if (
    ...
    !SAFE_HOST_PATTERN.test(normalized) ||
    normalized.includes("..") ||
    normalized.startsWith(".") ||
    normalized.endsWith(".")
  ) {
    throw new FirebaseRuntimeConfigurationError(
      "Firebase emulator host must be a plain local hostname or IPv4 address without a protocol, path or control characters.",
      "invalid-host",
    );
  }
